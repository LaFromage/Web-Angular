...
if(isset($_GET['ac'])){
	...
	?>
		...
		$_SESSION['tongtien']=0;
		for($i=0;$i<$count;$i++){
				$sql="select*from chitietsanpham where id_sp='{$_SESSION['giohang'][$i]['id']}'";
				...
				?>
					  <tr>
						<td height="30"><div class="tb"><b>Sản phẩm :</b><div class="tb01"><font size="3" style="font-family:Courier New;"><?php echo $row_sanpham['tensanpham'];?></font></div></div></td>
						<td height="30" width="120"><div class="tb"><b>Giá</b><div class="tb01"><?php echo number_format($row_sanpham['gia'],0,",",".");?> VNĐ</div></div></td>
						<td height="30" width="120"><div class="tb"><b>Số lượng :</b> <div class="tb01"><input type="text" disabled size="1" value="<?php echo $_SESSION['giohang'][$i]['soluong'];?>"/><a href="?xem=giohang&id=<?php echo $row_sanpham['id_sp'];?>"><button style="width:25px;">+</button></a><a href="?xem=giohang&ac=tru&id=<?php echo $row_sanpham['id_sp'];?>"><button style="width:25px;">-</button></a><a href="?xem=giohang&ac=xoa&id=<?php echo $row_sanpham['id_sp'];?>"><button style="width:25px;">Xóa</button></a></div></div></td>
