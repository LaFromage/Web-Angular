   <div class="title"><h3>KHUYẾN MÃI</h3></div>
	...
	$sql="select*from chitietsanpham where khuyenmai<>0 order by khuyenmai DESC limit $phantrang,$sosangpham1trang";
	$query_sql=mysqli_query($conn,$sql);
	while($row_sql=mysqli_fetch_assoc($query_sql)){
		include('modun/right/sanpham.php');
	}
	//phân trang	
	$sql_phantrang="select*from chitietsanpham where khuyenmai<>0";
