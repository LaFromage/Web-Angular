 ...
 if(isset($_POST['bt_timkiem'])){
	...
	$sql="select*from chitietsanpham where tensanpham like '%{$_SESSION['tim']}%' limit $phantrang,$sosangpham1trang ";
	...
	$sql_phantrang="select*from chitietsanpham where tensanpham like '%{$_SESSION['tim']}%'";
